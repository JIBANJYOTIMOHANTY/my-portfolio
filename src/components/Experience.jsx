...
const experiences = [
  {
    ...
    isCurrent: true,
    responsibilities: [
      "Designing, developing, and maintaining scalable enterprise web applications and reliable software solutions.",
      "Collaborating with cross-functional global teams in an Agile environment to build robust full-stack features.",
      "Implementing and integrating secure RESTful APIs, optimizing frontend-to-backend communication and system performance.",
      "Participating in code reviews, CI/CD pipelines, and adhering to high standards of code quality and software architecture."
    ],
    technologies: [
  ...
  },
  {
    ...
    technologies: ["Angular", "MySQL", "Service Layer", "Database Design", "Frontend & Backend Bridge"]
  }
];
  ...
  return (
    <div ref={ref} className="px-4 sm:px-6 lg:px-8 py-16 bg-transparent text-white" id="experience">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mt-8 flex flex-col items-center gap-10 relative">
          {experiences.map((exp, expIdx) => (
            <div
              key={expIdx}
              className="w-full md:w-11/12 lg:w-4/5 bg-black/40 border border-cyan-500/20 rounded-2xl p-6 md:p-8 hover:shadow-[0_0_25px_rgba(6,182,212,0.15)] hover:border-cyan-500/40 transition-all duration-300 ease-in-out group relative"
            >
              ...
              {/* Header info */}
              <div className="flex flex-col md:flex-row md:justify-between md:items-start border-b border-cyan-500/10 pb-6 mb-6 gap-4">
                <div className="flex-1 min-w-0">
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    {exp.isCurrent && (
                      <span className="px-2.5 py-0.5 rounded-full text-xs font-mono font-semibold bg-cyan-500/20 text-cyan-300 border border-cyan-500/40 animate-pulse">
                        Current
                      </span>
                    )}
                  </div>

                  <div className="flex flex-wrap sm:flex-nowrap items-center gap-2.5 sm:gap-3.5 mt-3 text-gray-400 text-sm md:text-base font-mono">
                    <span className="flex items-center gap-1.5 hover:text-cyan-400 transition-colors whitespace-nowrap">
                      <BusinessIcon fontSize="small" className="text-cyan-400" />
                      {exp.company}
                    </span>
                    <span className="hidden sm:inline text-gray-700">|</span>
                    <span className="flex items-center gap-1.5 hover:text-fuchsia-400 transition-colors whitespace-nowrap">
                ...
                <div className="mt-2 md:mt-0 flex-shrink-0">
                  <span className={`inline-flex items-center gap-2 px-4 py-1.5 rounded-lg text-xs md:text-sm font-mono font-semibold ${
                    exp.isCurrent 
                      ? "bg-cyan-950/40 text-cyan-300 border border-cyan-500/50 shadow-[0_0_10px_rgba(6,182,212,0.2)]" 
