...
const Education = () => {
    return (
        <div className="px-4 sm:px-6 lg:px-8 py-8 bg-[#2F2F2F]">
            <div className='flex flex-col items-center justify-center md:flex-row md:items-start'>
                <SchoolIcon sx={{ fontSize: 80, marginBottom:2}} />
            </div>
            ...
            <div className='flex flex-col md:flex-row md:space-x-4 mt-10'>
                ...
                <section className='w-full md:w-1/3 md:mt-1 space-y-3 md:ml-2'>
                ...
                <section className='w-full md:w-1/3 space-y-3 md:ml-4'>
